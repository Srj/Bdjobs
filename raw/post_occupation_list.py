...
file_open = data_folder + "job.dta"
data = pd.read_stata(data_folder + "job.dta")
data.rename(columns={' job_desc': 'job_desc', ' title': 'title'}, inplace=True)
...
# output data
data_occupation_output.to_csv(data_folder + 'data_occupation.csv')
